...
**@playwright/tes**t: Playwright's built-in testing framework for executing tests with Playwright.
...
├── tests
|   ├── features           # Example feature file in Gherkin syntax
...
Example: tests/step_definitions/loginSteps.ts
```
